...
`;var ie={},Ut=Ne;Object.defineProperty(ie,"__esModule",{value:!0});var ve=ie.default=void 0,Gt=Ut(Be()),Ht=We,Vt=(0,Gt.default)((0,Ht.jsx)("path",{d:"M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"}),"Close");ve=ie.default=Vt;const Zt=g.form`
  width: 400px;
  margin-bottom: ${e=>e.theme.space[3]};
  padding: ${e=>e.theme.space[3]};
  border: 1px solid ${e=>e.theme.colors.grey};
...
`,Yt=w(bt)(({theme:e})=>({"& .MuiDialogContent-root":{padding:e.spacing(2)},"& .MuiDialogActions-root":{padding:e.spacing(1)}}));function Ce(e){const{children:t,onClose:o,...r}=e;return h(Nt,{sx:{m:0,p:2},...r,children:[t,o?s(it,{"aria-label":"close",onClick:o,sx:{position:"absolute",right:8,top:8,color:n=>n.palette.grey[500]},children:s(ve,{})}):null]})}Ce.propTypes={children:$.node,onClose:$.func.isRequired};function $e({name:e,number:t,contactId:o}){const[r,n]=y.useState(!1),a=()=>{n(!0)},l=()=>{n(!1)},i=D(oe),c=O(),p=m=>{if(!i)return;const f=m.toLowerCase().trim();return i.find(({name:v})=>v.toLowerCase()===f)},b=m=>{m.preventDefault();const f=new FormData(m.target),v=Object.fromEntries(f.entries()),{name:B,number:W}=v,k=ae(B);if(p(B)){alert(`Sorry, ${k} has already added!`);return}c(Ie({contact:{name:k,number:W},contactId:o})),ne.Notify.success("Contact has updated!"),m.currentTarget.reset()};return h("div",{children:[s(qt,{variant:"outlined",onClick:a,children:"Update"}),h(Yt,{onClose:l,"aria-labelledby":"customized-dialog-title",open:r,children:[s(Ce,{id:"customized-dialog-title",onClose:l,children:"Update contact details"}),s(wt,{dividers:!0,children:h(Zt,{onSubmit:b,children:[h(de,{children:["Name",s(pe,{type:"text",name:"name",placeholder:"FirstName LastName",pattern:"^[a-zA-Zа-яА-Я]+(([' -][a-zA-Zа-яА-Я ])?[a-zA-Zа-яА-Я-яЁёІіЇїЄє]*)*$",title:"Name may contain only letters, apostrophe, dash and spaces. For example Adrian, Jacob Mercer, Charles de Batz de Castelmore d'Artagnan",required:!0})]}),h(de,{children:["Number",s(pe,{type:"tel",name:"number",placeholder:"123-45-67",pattern:"\\+?\\d{1,4}?[-.\\s]?\\(?\\d{1,3}?\\)?[-.\\s]?\\d{1,4}[-.\\s]?\\d{1,4}[-.\\s]?\\d{1,9}",title:"Phone number must be digits and can contain spaces, dashes, parentheses and can start with +",required:!0})]}),s(Ve,{type:"submit",autoFocus:!0,onClick:l,onSubmit:b,sx:{marginLeft:"auto",marginRight:"auto"},children:"Save changes"})]})})]})]})}$e.propTypes={name:$.string.isRequired,number:$.string.isRequired,contactId:$.string.isRequired};function ke(e){const t=D(re),o=O(),{contactInfo:{name:r,number:n,id:a}}=e,l=c=>(ne.Notify.warning("Contacts has deleted"),o(Pe(c))),i=ae(r);return h(Lt,{children:[s(jt,{}),h(Et,{children:[i,": ",n]}),s($e,{name:i,number:n,contactId:a}),s(At,{type:"button",onClick:()=>l(a),disabled:t==="loading",children:"Remove"})]})}ke.propTypes={contactInfo:$.PropTypes.shape({name:$.PropTypes.string.isRequired,number:$.PropTypes.string.isRequired,id:$.PropTypes.string.isRequired})};const Xt=g.ul`
  display: flex;
